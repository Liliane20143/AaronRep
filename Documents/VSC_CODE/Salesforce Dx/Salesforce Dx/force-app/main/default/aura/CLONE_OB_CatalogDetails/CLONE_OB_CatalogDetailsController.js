({
	...
	goBackToListiniTable: function(component, event, helper) { 
		component.set("v.goToListiniTable", true);
	...
	handleNewRowRightSequence: function(component, event, helper) {
	    ...
	    { 
	    	...
	    	document.getElementById('newRow_SequenceError').classList.remove('borderError');
			...
			document.getElementById('newRow_SequenceError').classList.add('borderError');
					 ...
					 if(parentChildrenRows[parseInt(index)].cloneId == parentChildrenRows[i].parent.Id && parentChildrenRows[i].cloneId == ''){ // finding its parent
					  console.log("it is a match!");
						...
						console.log("end date it's not empty!");
							...
							console.log("parent end date it's not empty..");
							component.set("v.spinner", false);
						}
					 }
				}	  
