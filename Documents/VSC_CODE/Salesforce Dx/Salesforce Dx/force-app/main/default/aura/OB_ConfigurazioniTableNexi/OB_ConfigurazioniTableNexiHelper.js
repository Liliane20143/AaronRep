({
	loadConfigurazioni : function(component,page) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
				...
				*/ 
				...
				//console.log("result  configurazioniList " + JSON.stringify(result));
				//component.set("v.configurazioniList", result.configurazioniList);
				
				//console.log("response  configurazioniList " + JSON.stringify(result.configurazioniList));
				...
				// console.log("response  pickListPrezzi  :"     + JSON.stringify(result.pickListPrezzi));
				// console.log("response  pickListModelli : " + JSON.stringify(result.pickListModelli));
		...
		var actionComponent = component.get('c.listProducts');
		//action.setParams({});
		actionComponent.setCallback(this, function(response) {
				var pageList = [];
				var state = response.getState();
				if (state === 'SUCCESS') {
		...
		$A.enqueueAction(actionComponent);
		component.set("v.Spinner", true);

	  //Doris D....15/03/2019.......Fin
	},
	...
	searchconfigurazioni: function(component,page) {
		...
		console.log("nameProduct searchconfigurazioni ***** "+name);
		...
		var offerta = component.get("v.offerta").Name;
		//francesca.ribezzi - adding abi to action's params:
		var abi = component.get("v.selectedABI").Name;
