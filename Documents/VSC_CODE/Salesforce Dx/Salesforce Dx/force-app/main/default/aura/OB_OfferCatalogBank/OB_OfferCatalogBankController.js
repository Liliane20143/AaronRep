({
  ...
  // function for clear the Record Selaction 
    ...
    handleActivationBtn:function(component,event,helper){
    	...
    	var bundleOffers = component.get("v.bundleOffers"); //activated offers!
    	...
    	if(btn.value == "active"){
    		...
    		//if button value is active, that means that you want to activate that offer. 
    		//checking if this offer is already in for this bank:
  ...
  /*  handleSaveRows:function(component,event,helper){
   ...
   /*  handleSaveRows:function(component,event,helper){
    ...
    callConfigure :function(component,event,helper){
    	...
    	component.set("v.selectedOffer", offer);
    	component.set("v.goToConfigurazioniTableNexi", true);
    /*	var evt = $A.get("e.force:navigateToComponent");
    	
	    evt.setParams({
	        componentDef : "c:OB_ConfigurazioniTableNexi", //Nexi per Banca
	        componentAttributes: {
	            offerta : offer,
