...
//****************************************************************************************************************************//
    ...
    handleErrorEvent: function(component, event, helper) {
     ...
     //**********METHOD TO SET THE NEW MERCHANT NAME(DENOMINAZIONE SOCIALE)**********//
    setValue : function(component, event, helper) {
        var objectDataMap = component.get("v.objectDataMap");
        console.log("INTO THE SET NEW NAME");
        var newName= document.getElementById("newName").value;
        console.log("new name is: " +  newName);
       component.set("v.objectDataMap.merchant.OB_New_Name__c", newName);
       console.log("OBJ MERCHANT NEW NAME-----> " + JSON.stringify(objectDataMap.merchant));
