({
	...
	doInit : function(component, event, helper)
	{
		...
		//setting configurations as CAB list to TEST:
		var configurations = component.get("v.configurations");
		configurations.push('01623');
	...
	goBackToConfigurazioniTableCAB: function(component, event, helper)
	{
		component.set("v.goToConfigurazioniTableCAB", true);
	},
...
//                    <= OB_Massimo__c <= OB_Massimale__c
	...
	//LUBRANO 2019-02-04 - Aggiunta controllo validità date
