	...
	getValue: function(component, event, helper) {
		...
		for (var key in component.get("v.responseCom")){
			...
			if(component.get("v.responseCom")[key]==comune){
				...
				//START - elena.preteni WN-86 30/07/2019 
				component.set('v.cityString',comune);
				break;
				//END - elena.preteni WN-86 30/07/2019 
			}
			// START---simone.misani@accenture.com PRODOB-89 26/04/2019 
			else{
			 	component.set('v.cityString','');
			}
			// END---simone.misani@accenture.com PRODOB-89 26/04/2019 
		}
...
callCities : function(component, event, helper) {
	console.log("****in callCities");
		...
		action.setCallback(this, function(response){
			...
			if (state === "SUCCESS") {
				...
				helper.city(component, event , helper); //NEXI-322 Kinga Fornal <kinga.fornal@accenture.com>, 13/09/2019
			} 
	...
	comune: function(component, event , helper){
        ...
        j$('[id$="'+comuneId+'"]').autocomplete({source: []});
