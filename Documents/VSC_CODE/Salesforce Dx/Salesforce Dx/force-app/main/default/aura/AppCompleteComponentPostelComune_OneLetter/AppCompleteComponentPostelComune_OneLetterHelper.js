({
    getResponse : function(component, url, field) {
     ...
     city : function(component, event , helper)
     {
             ...
             if(coms!=null && typeof coms == 'object' ){
     	        ...
     	        component.set('v.comuniList',listaComuni);
     	        //console.log('comuni'+component.get('v.comuni'));
    ...
    nowyAutocomplete : function(component)
    {
        let listaComuni = component.get("v.comuniList");
        let comuneId = component.get("v.cityId");
        let inputValue =component.get("v.cityString");
        let inputValue2 = document.getElementById(comuneId).value;
        let listaComuniFiltered = listaComuni.filter(function(value)
        {
