({ 
	 doInit : function(component, event, helper) {
		...
		console.log("__init");
		console.log('page init: ' + component.get('v.pagesTmp'));
		
		//console.log("abiCablov: ", component.get("v.abiCabLov"));
		// if(component.get('v.pageBack')==undefined && component.get('v.isBack')==undefined){
			// alert('page: '+ component.get('v.page'));
			//giovanni spinelli 27/02/2019 - pass page number to have saved the selected page
    ...
    editConfigurazione :function(component, event, helper) {
		...
		console.log("matrixParameter: ",configurazioniList[configurazioneIndex] );
        component.set("v.matrixParameter",configurazioniList[configurazioneIndex]);
        component.set("v.openEditConfiguration",true);
	    ...
	    // evt.setParams({
	    //     componentDef : "c:OB_ConfigurationDetailsBank", //Banca
	    //     componentAttributes: {
	    //         offer: offerta,
	...
	cleanForms:function(component,event,helper){
		...
		//LUBRANO 2019-03-28 -- reloading configurations
		var page = component.get('v.page');
		helper.searchconfigurazioni(component,page);

	},
	goBackToOffertaTable: function(component, event, helper) { 
		component.set("v.goBackToOfferCatalogBankCAB", true);
	   //  START   micol.ferrari 18/11/2018 - NOT WORKING IN COMMUNITY
		// var event = $A.get("e.force:navigateToComponent");
	 //    event.setParams({
	 //        componentDef : "c:OB_OfferCatalogBank"
	 //    });
	 //    event.fire(); 
        //  END   micol.ferrari 18/11/2018 - NOT WORKING IN COMMUNITY
	},
...
changeComponente: function(component, event, helper) { 
    ...
    //  START   micol.ferrari 18/11/2018
    backToConfigurazioniTableBank : function(component,event,helper)
    {
        component.set("v.openEditConfiguration",false);
    },
	...
	openTooltipListino : function (component,event,helper){		
		component.set("v.showMessageListino", true);
	},

	closeTooltipListino: function (component,event,helper){
		component.set("v.showMessageListino", false);
	},

	openTooltipValidita : function (component,event,helper){		
		component.set("v.showMessageValidita", true);
	},

	closeTooltipValidita: function (component,event,helper){
		component.set("v.showMessageValidita", false);
	},

	openTooltipCatalogOffer : function (component,event,helper){		
		component.set("v.showMessageCatalogOffer", true);
	},
	closeTooltipCatalogOffer : function (component,event,helper){
		component.set("v.showMessageCatalogOffer", false);
	},		
