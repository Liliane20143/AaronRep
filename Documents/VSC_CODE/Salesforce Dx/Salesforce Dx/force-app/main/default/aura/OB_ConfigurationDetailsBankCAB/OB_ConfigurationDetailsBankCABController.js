({
	...
	goBackToConfDetailsBankCmp: function(component, event, helper) { 
        var event = $A.get("e.force:navigateToComponent");
	    event.setParams({
	        componentDef : "c:OB_ConfigurationDetailsBank",
	        componentAttributes : {
	        	offerta: component.get("v.offer"),
	        	abiCabLov: component.get("v.abiCabLov")
	        }	
	    });
	    event.fire(); 
    },
	...
	createNewMatrixRow: function(component, event, helper) { 
		...
		var newRow = {'sobjectType':'NE__Matrix_Parameter_Row__c', 'OB_Massimale__c':'0', 'OB_Massimo__c':'0','OB_Minimo__c':'0', 'OB_Soglia_Max_Approvazione__c':'0','OB_Soglia_Min_Approvazione__c' : '0','OB_Valore_Default__c' :'0', 'OB_SelfLookup__c' : '', 'OB_Product__c' : '', 'OB_Codici__c' : ''};
	...
	onChangeConfigurationType: function(component, event, helper) { 
		//var value = event.target.value;
		console.log("into onChangeCatalogItem");
		var configId= event.getSource().get("v.value");
